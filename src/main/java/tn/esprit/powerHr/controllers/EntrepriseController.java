...
import tn.esprit.powerHr.models.Country;
import tn.esprit.powerHr.services.EntrepriseService;
import tn.esprit.powerHr.services.SmsVerificationService;
...
public class EntrepriseController implements Initializable {
    ...
    private void verifyPhone() {
        ...
        if (result.getBoolean("success")) {
            ...
            submitVerificationBtn.setDisable(false);
        } else {
            showAlert(Alert.AlertType.ERROR, "Error", 
    ...
    private void submitVerificationCode() {
        ...
        JSONObject result = smsVerificationService.verifyCode(phoneNumber, code);
